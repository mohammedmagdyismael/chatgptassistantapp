  ...
  return (
        <div>
          ...
          <div className='role-container'>
            <input placeholder='ex: Create 5 social media captions for the following page content' className='role-input' type="text" value={query} onChange={e => setQuery(e.target.value)} />
          </div>
          ...
          <form onSubmit={handleMessageSubmit}>
            <textarea placeholder='Put Your Paragraph Here!' className='query-input' name="Text1" cols="42" rows="5" value={input} onChange={handleChange} />
